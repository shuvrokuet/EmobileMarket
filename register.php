...
<!-- Sidebar end=============================================== -->
	...
	<form class="form-horizontal" action="register_process.php" method="post">
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" name="input_name" id="inputFname1" placeholder="Name">
			</div>
		 </div>
		<div class="control-group">
	...
	<div class="control-group">
		...
		<div class="controls">
		  <input type="password" name="input_password" id="inputPassword1" placeholder="Password">
		</div>
	  </div>	  
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" name="input_postcode" id="postcode" placeholder="Zip / Postal Code"/> 
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text"  name="input_mobile" id="mobile" placeholder="Mobile Phone"/> 
			</div>
		</div>
